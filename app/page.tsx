...
export default function Page() {
  ...
  return (
    <>
      ...
      <main className="page-shell pb-36 sm:pb-20 lg:pb-24">
        <div className="pointer-events-none absolute inset-x-0 top-0 h-[480px] bg-[radial-gradient(circle_at_top,rgba(143,117,255,0.22),transparent_58%)]" />
        <div className="pointer-events-none absolute right-[-10%] top-[20%] hidden h-[320px] w-[320px] rounded-full bg-[radial-gradient(circle,rgba(124,247,255,0.12),transparent_70%)] blur-3xl sm:block" />
